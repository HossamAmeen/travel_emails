...
$template_data =  $twig->render('charter_flight_multi_flights.html.twig', $_POST);
...
send_email('charter flight multi flights', 'Ops@whitecloudsaviation.com' , $template_data, $template_data, $file_name, $user_name);
