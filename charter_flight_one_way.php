...
$file_name = "charter_flight_one_way";
...
$template_data =  $twig->render('charter_flight_one_way.html.twig', $_POST);
...
send_email('charter flight one way', 'Ops@whitecloudsaviation.com' , $template_data, $template_data, $file_name, $user_name);
